...
- [New VarDumper Component and DebugBundle](http://symfony.com/doc/master/components/var_dumper/introduction.html)
...
During the development of symfony 2.6 they also introduced a new [symfony installer](https://github.com/symfony/symfony-installer). This tool will make it 
even easier for beginners to setup a working symfony installation.